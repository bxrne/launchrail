...
document.addEventListener('DOMContentLoaded', function() {
    ...
    tabs.forEach(tab => {
        tab.addEventListener('click', () => {
            ...
            tabs.forEach(t => t.classList.remove('active', 'border-bottom', 'color-border-accent-emphasis', 'color-fg-accent'));
            tabContents.forEach(tc => tc.classList.remove('active'));
            
            // Add active class to the clicked tab and corresponding content
            tab.classList.add('active', 'border-bottom', 'color-border-accent-emphasis', 'color-fg-accent');
