...
func TestNewNosecone(t *testing.T) {
	...
	nosecone := entities.NewNosecone(id, radius, length, mass, shapeParameter)
...
func TestNosecone_String(t *testing.T) {
	...
	expected := "Nosecone{ID: 1, Position: Vector3{X: 0.00, Y: 0.00, Z: 0.00}, Radius: 1.00, Length: 2.00, Mass: 0.50, ShapeParameter: 0.10}"
